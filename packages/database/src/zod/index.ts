...
export const PublicationScalarFieldEnumSchema = z.enum(['id','title','account','type','publishDate','status','views','likes','userId','createdAt','updatedAt']);

export const PromptScalarFieldEnumSchema = z.enum(['id','name','content','references','referenceType','userId','createdAt','updatedAt']);
...
export const ReferenceTypeSchema = z.enum(['TEXT','LINKS','FILES']);
